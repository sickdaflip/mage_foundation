...
(function ($, ui) {
    ...
    ui.getUIElements = function (options, $el) {
        ...
        if (options.ui.showVerdictsInsideProgressBar) {
            result.$verdict = result.$progressbar.find("p.progress-meter-text");
        }

        if (!options.ui.showPopover) {
            if (!options.ui.showVerdictsInsideProgressBar) {
                result.$verdict = ui.findElement($container, options.ui.viewports.verdict, "p.progress-meter-text");
            }
    ...
    ui.initProgressBar = function (options, $el) {
        var $container = ui.getContainer(options, $el),
            progressbar = "<div class='progress' role='progressbar'><span class='progress-meter' style='width:0%'>";
        if (options.ui.showVerdictsInsideProgressBar) {
            progressbar += "<p class='progress-meter-text'></p>";
        }
        progressbar += "</span></div>";
    ...
    ui.initVerdict = function (options, $el) {
        ui.initHelper(options, $el, "<p class='progress-meter-text'></p>",
